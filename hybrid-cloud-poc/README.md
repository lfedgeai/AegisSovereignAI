...
Aegis secures the environment where AI executes, providing a path from integrity to full confidentiality.
...
* **Integrity for Legacy/Edge:** On commodity hardware, Aegis uses **Keylime** and **TPM 2.0** to verify the software stack's **Integrity** (via IMA/EVM), proving the code is untampered even if it isn't encrypted-in-use.

### Layer 2: Workload Identity (The Provable Bridge)

Aegis replaces fragile bearer tokens with hardware-rooted possession, binding **Who** is running to **Where** and **on what Silicon** they are running.
...
High-level policy (e.g., Reg-K, Fair Lending) becomes a mathematical constraint via **Zero-Knowledge Proofs (ZKP)**.
...
AegisSovereignAI applies its three-layer architecture across the entire AI lifecycle, enhancing strategic value by securing data, models, and execution.
...
AegisSovereignAI doesn't just align with standards; it **enhances** them by turning high-level frameworks into **executable, verifiable code**.
...
* **Hybrid Cloud PoC:** This document—full integration of **SPIRE** and **Keylime** for Real-Time Node Revocation.
* **Unified Identity Architecture:** Technical deep-dive into [Managed vs. BYOD Workload Provenance](./README-arch-sovereign-unified-identity.md).
* **Threat Model:** Analysis of the [Runtime Perception Gap and Sensor Fusion](./THREAT-MODEL-runtime-perception-gap.md).

---

[Architecture Deep Dive](../docs/arch.md) | [IETF WIMSE Draft](https://datatracker.ietf.org/doc/draft-lkspa-wimse-verifiable-geo-fence/) | [EU AI Act Mapping](../docs/compliance-mapping.md)