...
// 1.3.6.1.4.1.65284.1.1 = 0x2b, 0x06, 0x01, 0x04, 0x01, 0x83, 0xfe, 0x04, 0x01, 0x01
const UNIFIED_IDENTITY_OID_STR: &str = "1.3.6.1.4.1.65284.1.1";
const LEGACY_OID_STR: &str = "1.3.6.1.4.1.65284.1.1";
