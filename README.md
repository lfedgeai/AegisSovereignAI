...
*   **[Threat Model: Unmanaged Device Perception Gap](./hybrid-cloud-poc/THREAT-MODEL-unmanaged-device-perception-gap.md)** - Analysis of **Infrastructure Blind Spots** on **BYOD/Unmanaged Devices**, detailing how AegisSovereignAI prevents locality spoofing via hardware-rooted sensor fusion.
